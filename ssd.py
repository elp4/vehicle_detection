...
SAVE_PATH = "D:/videos/camera4/output/conf_" + str(CONFIDENCE_THRESHOLD) + "/iou_" + str(IOU_THRESHOLD) + "/ssd_1.mp4"
...
def process_video():
    ...
    cv2.resizeWindow('SSD Detection', 1280, 720)
    ...
    while cap.isOpened():
        ...
        selected_classes = {3, 4, 6, 8}  # Car, Motorcycle, Bus, Truck
...
def save_info_to_txt(elapsed_time):
    ...
    with open(txt_path, 'w') as f:
        ...
        f.write(f"Using model: SSD: Single Shot MultiBox Detector {device}\n")
